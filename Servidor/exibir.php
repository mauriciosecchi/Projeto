...
require_once "functions.php";
 ...
 $db = conectadb();
	...
	{		
		...
		echo "		<tr> ";
		echo "			<th class='bg'></th> ";
		echo "			<th><strong>Segunda " . date('d/m/Y', $_SESSION['dataatual']) . "</strong></th> ";
		...
		{		 
			...
			for($i=0; $i<7; $i++){
				...
				else
				{
					$id_reserva =  0;
					$apelido = 'Disponível';
					$exibir = "<a href='tmp.php?id_reserva=0&id_quadra=$quadra&data=$timestamp&hora=$soma' class='itemreserva'>$apelido</a>";		
				}
